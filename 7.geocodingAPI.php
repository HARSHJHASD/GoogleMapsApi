AIzaSyCKZSz15pAPOtTYd4wFssX8AIfZR7bPZu0<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div id="output"></div>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKZSz15pAPOtTYd4wFssX8AIfZR7bPZu0"></script>
        ...
        <script>
            ...
            function geocodeAddress(){
                var url = "https://maps.googleapis.com/maps/api/geocode/json?address="+document.getElementById("address").value+"&key=AIzaSyCKZSz15pAPOtTYd4wFssX8AIfZR7bPZu0";
//                window.open(url);
